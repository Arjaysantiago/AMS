...
namespace Animal_Management_System
{
    public partial class ResetPasswordforEmployee : Form
    {
        ...
        private void btnverify_Click(object sender, EventArgs e)
        {
            ...
            using (SqlConnection conn = new SqlConnection("data source=(LocalDB)\\MSSQLLocalDB;AttachDbFilename=C:\\Users\\user\\source\\repos\\webapp\\Animal Management System\\DatabaseAKF.mdf;"))
            {
                try
                {
                    conn.Open();
